...
class Contact extends Component {
    ...
    //Add new method to handle input changes
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        else if (this.state.touched.firstname && firstname.length > 14)
            errors.firstname = 'First name should be <=14 characters';

        if (this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Last name should be >= 3 characters';
        else if (this.state.touched.lastname && lastname.length > 14)
            errors.lastname = 'Last name should be <=14 characters';
        ...
        //TODO:Implement more restrictionss for tel.number (number of digits should be equal to 10 digits)
